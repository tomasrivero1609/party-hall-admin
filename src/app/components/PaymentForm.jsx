...
const paymentSchema = z.object({
  ...
  payerName: z.string().min(1, "El nombre del pagador es obligatorio"), // Nuevo campo
  date: z.string().min(1, "La fecha es obligatoria"), // Validación para el campo de fecha
});
...
const PaymentForm = () => {
  ...
  const [formData, setFormData] = useState({
    eventId: "",
    amount: "0",
    payerName: "", // Nuevo campo
    date: "", // Campo de fecha como texto
  });
